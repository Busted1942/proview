...
# v3.1 (Build module, commented edition)
...
- v3.1: No Build rule changes. Version aligned with Core v3.1 (Rule 2D expression layer; 2A deduplication rule; 2C inline-floor clause). Bumped only to keep the six-file set on a single version per the v2.9 precedent; a Build v3.0↔v3.1 diff shows no rule content change.
